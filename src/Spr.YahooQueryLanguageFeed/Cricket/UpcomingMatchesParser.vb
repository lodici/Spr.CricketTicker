...
Friend Class UpcomingMatchesParser
    ...
    Public Shared Function GetListOfUpcomingMatches(xml As XmlDocument) As List(Of UpcomingMatch)
        Return GetListOfUpcomingMatches(xml, Today)
    End Function

    Public Shared Function GetListOfUpcomingMatches(xmlDoc As XmlDocument, afterDate As Date) As List(Of UpcomingMatch)
        If xmlDoc IsNot Nothing Then
            Return (
                From xe As XElement In xmlDoc.ToXDocument.<query>.<results>.<Match>
