...
#End Region
    ...
    Private Shared Function IdentifyScorecardXElement(xmlDoc As XmlDocument, seriesId As Integer) As XElement
        Return (
            From xe As XElement In xmlDoc.ToXDocument.<query>.<results>.<Scorecard>
            Where xe.<series>.<series_id>.Value = seriesId.ToString
            Select xe)(0)
    End Function
